...
Recruitment Team`,
  ...
  const interviewTypes = [
    { value: "physical", label: "In-Person Interview", icon: Users },
    { value: "virtual", label: "Video Interview", icon: Video },
  ...
  useEffect(() => {
    const loadAvailableTests = async () => {
      try {
        ...
        const response = await currentVacanciesAPI.getAvailableTests();
