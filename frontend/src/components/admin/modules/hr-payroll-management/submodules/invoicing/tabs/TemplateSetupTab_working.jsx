                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700">
                          ...
                          {selectedGrade.job_structure &&
                            ` â€¢ ${selectedGrade.job_structure.job_title}`}
                        </p>
                      </div>
                    </div>
                    <button
              ...
              <div className="col-span-2">
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    placeholder="Enter your formula here (e.g., 8 * Basic_Salary + Housing)"
