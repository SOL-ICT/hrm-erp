...
const AcceptOfferSection = ({ currentTheme, preferences, user }) => {
  ...
  const validateStep = (step) => {
    ...
    if (step === 2) {
      if (
        !candidateDetails.nin_number ||
        candidateDetails.nin_number.length !== 11
      ) {
        newErrors.nin_number = "NIN must be exactly 11 digits";
      }
      if (
        !candidateDetails.bvn_number ||
        candidateDetails.bvn_number.length !== 11
      ) {
    ...
    if (step === 3) {
      if (!candidateDetails.bank_name)
        newErrors.bank_name = "Bank name is required";
      if (
        !candidateDetails.account_number ||
        candidateDetails.account_number.length !== 10
      ) {
        newErrors.account_number = "Account number must be exactly 10 digits";
      }
      if (!candidateDetails.account_name)
        newErrors.account_name = "Account name is required";
      if (!candidateDetails.pfa_name)
        newErrors.pfa_name = "PFA name is required";
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Progress Indicator */}
      <div
        className={`${currentTheme.cardBg} backdrop-blur-md rounded-2xl p-6 ${currentTheme.border} shadow-xl`}
      >
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className={`text-sm ${currentTheme.textMuted}`}>
                          Salary: ₦{offer.salary_amount?.toLocaleString()}{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full p-4 rounded-xl ${currentTheme.cardBg} ${
                    currentTheme.border
                  } ${
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-700 text-sm">
                    Your NIN and BVN are required for identity verification and
                    compliance purposes. This information is securely encrypted
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("pfa_name", e.target.value)
                      }
                      className={`w-full p-4 rounded-xl ${
                        currentTheme.cardBg
                      } ${currentTheme.border} ${
                    ...
                    >
                      ...
                      <option value="ARM Pension Managers">
                        ARM Pension Managers
                      </option>
                      <option value="AXA Mansard Pension">
                        AXA Mansard Pension
                      </option>
                      <option value="Crusader Sterling Pensions">
                        Crusader Sterling Pensions
                      </option>
                      <option value="Fidelity Pension Managers">
                        Fidelity Pension Managers
                      </option>
                      <option value="First Guarantee Pension">
                        First Guarantee Pension
                      </option>
                      <option value="Investment One Pension Managers">
                        Investment One Pension Managers
                      </option>
                      <option value="Leadway Pensure">Leadway Pensure</option>
                      <option value="NLPC Pension Fund Administrators">
                      ...
                      <option value="Pensions Alliance Limited">
                      ...
                      <option value="Stanbic IBTC Pension Managers">
                        Stanbic IBTC Pension Managers
                      </option>
                      <option value="Tangerine APT Pensions">
                        Tangerine APT Pensions
                      </option>
                      <option value="Trustfund Pensions">
                        Trustfund Pensions
                      </option>
                      <option value="Veritas Glanvills Pensions">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("pfa_pin", e.target.value)
                      }
                      className={`w-full p-4 rounded-xl ${
                        currentTheme.cardBg
                      } ${currentTheme.border} ${
        ...
        {currentStep === 4 && (
          <div className="space-y-6">
            ...
            <div className="space-y-6">
                  ...
                  {candidateDetails.signature_preview ? (
                    <div>
                      <Image
                        ...
                        width={300}
                        height={128}
                        className="max-h-32 mx-auto mb-4 border rounded object-contain"
                      />
                      ...
                      <button
                        onClick={() =>
                          handleInputChange("signature_preview", null)
                        }
                    ...
                    <div>
                      ...
                      <p
                        className={`${currentTheme.textPrimary} font-medium mb-2`}
                      >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm">
                      By providing your digital signature, you confirm that you
                      accept the terms and conditions of the job offer. This
                      action is legally binding and cannot be undone.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Summary */}
              <div
                className={`${currentTheme.cardBg} rounded-xl p-6 ${currentTheme.border}`}
              >
                <h4
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className={`${currentTheme.textPrimary} font-medium`}>
                      ...
                      {selectedOffer?.salary_frequency}
                    </p>
                  </div>
                  <div>
        ...
        <div className="flex justify-between pt-8 border-t">
          ...
          {currentStep < 4 ? (
            <button
              ...
              disabled={(currentStep === 1 && !selectedOffer) || isLoading}
