...
export default function LeaveApprovalPage() {
  ...
  const fetchApplicationDetails = async () => {
    try {
      ...
      console.log('🔍 LeaveApprovalPage fetchApplicationDetails DEBUG:');
  ...
  const handleSubmitDecision = async () => {
    ...
    try {
      ...
      console.log('🔍 LeaveApprovalPage handleSubmitDecision DEBUG:');
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-4">
            Leave application has been {decision === 'approved' ? 'approved' : 'rejected'} successfully.
          </p>
      ...
      <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-base font-medium text-gray-900">
                      {application?.staff?.name || application?.staff_name}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Email</p>
                    <p className="text-base text-gray-900">
                      {application?.staff?.email || application?.staff_email}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-base text-gray-900">
                      {application?.handover_staff?.name || application?.handover_staff || 'Not specified'}
                    </p>
                  </div>
                  <div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            >
              <CheckCircle className={`w-8 h-8 mx-auto mb-2 ${decision === 'approved' ? 'text-green-600' : 'text-gray-400'}`} />
            ...
            >
              <XCircle className={`w-8 h-8 mx-auto mb-2 ${decision === 'rejected' ? 'text-red-600' : 'text-gray-400'}`} />
