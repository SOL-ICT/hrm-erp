...
class LeaveApplication extends Model
{
    ...
    // Disable Laravel's default timestamps since we use applied_at instead
    ...
    /**
     * Get the staff member who will cover during leave (handover)
     */
    ...
    /**
     * Get the supervisor information for this leave application
     */
    public function supervisor(): BelongsTo
    {
        return $this->belongsTo(StaffSupervisor::class, 'supervisor_id');
    }
