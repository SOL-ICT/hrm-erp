...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Add FIRS e-invoicing related fields to sol_master_details table
     */
    public function up(): void
    {
        Schema::table('sol_master_details', function (Blueprint $table) {
            ...
            $table->string('business_id', 100)->nullable()->after('country')
                ->comment('FIRS business ID for e-invoicing');
        });
    }
